...
from DAGNet_model.model_attn_aff_coco import DAGNet
...
def validate(model=None, data_loader=None, cfg=None):
    ...
    for _, data in tqdm(enumerate(data_loader),
        ...
        # cams += list(cam.numpy().astype(np.int16))
        ...
        if num % 1000 == 0:
            ...
            cam_hist, cam_score = evaluate.scores(gts, cams, cam_hist, num_classes=cfg.dataset.num_classes)
            preds, gts, cams, aff_gts = [], [], [], []
        # if num % 1000 == 0:
